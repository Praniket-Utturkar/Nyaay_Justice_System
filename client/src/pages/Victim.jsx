...
const Victim = () => {
  ...
  return (
    <div className="login h-screen  bg-no-repeat bg-cover "  style={{ backgroundImage: `url(${victimbg})` }}  >
      <Navbar/>
...
<p className=' text-2xl font-semibold my-2'>Convict Login</p>
<div className="id grid grid-cols-4 my-2">
  <label htmlFor="id">CNR ID : </label>
...
<div className="btn">
<button className=' bg-slate-200 px-3 py-1 shadow-md rounded-md  '>Submit</button>
</div>
